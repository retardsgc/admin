...
const CategoryFormModal: React.FC<CategoryFormModalProps> = ({
  ...
  useEffect(() => {
    if (category && mode === 'edit') {
      ...
      // For new categories, default order is totalCategories + 1
      setFormData({
        name: '',
        slug: '',
        description: '',
        ...
        metaTitle: '',
        metaDescription: '',
        displayOrder: totalCategories + 1,
        adminNotes: ''
      });
    }
    setErrors({});
  }, [category, mode, isOpen, totalCategories]);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, displayOrder: Math.max(1, parseInt(e.target.value) || 1) }))}
              ...
              <p className="text-muted-foreground text-xs mt-1">
                Lower numbers appear first. Drag rows in the table to reorder.
              </p>
            </div>
          </div>
